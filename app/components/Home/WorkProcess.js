    ...
    return (
        <>
            ...
            <div className='bg-darkBlack flex items-center py-28'>
                <div className='container mx-auto'>
                    <div className='flex workHeight flex-wrap w-full'>
                        <div className='flex flex-col justify-start text-center w-2/12 p-3'>
                            <div className='flex flex-col items-center p-5 processBorderF ' >
                                <p className='text-white text-2xl font-semibold mb-16'>Strategic <br />Start</p>
                        ...
                        <div className='flex flex-col justify-end text-center w-2/12 p-3'>
                        ...
                        <div className='flex flex-col justify-end text-center w-2/12 p-3'>
                            ...
                            <div className='flex flex-col items-center p-5 processBorderR ' >
                            <p className='text-white text-6xl colorText bg-tPurple w-48 h-48 flex items-center justify-center rounded-full border-8 border-bPurple'>04</p>
